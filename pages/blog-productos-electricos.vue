<template>
  <div class="pt-16 pb-8 px-4">
    ...
    <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 pb-8">
      Blog, Noticias e Innovacion: Productos Eléctricos
    </h1>
    <!-- Filtros -->
...
const { data: posts } = await useAsyncData("posts", () =>
  $fetch(`${config.public.apiBase}/blog/category/Productos Eléctricos`)
);
...
// SEO de blog
useHead({
  title: "Blog Productos Electricos",
  meta: [
    {
      name: "description",
      content: "Blog Productos Electricos",
    },
    {
      name: "keywords",
      content:
