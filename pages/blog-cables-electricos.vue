<template>
  <div class="pt-16 pb-8 px-4">
    ...
    <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 pb-8">
      Blog, Noticias e Innovacion: Cables Eléctricos
    </h1>
    <!-- Filtros -->
...
const { data: posts } = await useAsyncData("posts", () =>
  $fetch("https://clownfish-app-xjood.ondigitalocean.app/api/blog/category/Cables Eléctricos")
);
...
// SEO de blog
useHead({
  title: "Blog Cables Electricos",
  meta: [
    {
      name: "description",
      content: "Blog Cables Electricos",
    },
    {
      name: "keywords",
      content:
  ...
  link: [{ rel: "canonical", href: "https://jdelectricos.com.co/blog-cables-electricos/" }],
});
</script>
