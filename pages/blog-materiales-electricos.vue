<template>
  <div class="pt-16 pb-8 px-4">
    ...
    <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 pb-8">
      Blog, Noticias e Innovacion: Materiales Eléctricos
    </h1>
    <!-- Filtros -->
...
const { data: posts } = await useAsyncData("posts", () =>
  $fetch("https://clownfish-app-xjood.ondigitalocean.app/api/blog/category/Materiales Eléctricos")
);
...
// SEO de blog
useHead({
  title: "Blog Materiales Electricos",
  meta: [
    {
      name: "description",
      content: "Blog Materiales Electricos",
    },
    {
      name: "keywords",
      content:
  ...
  link: [{ rel: "canonical", href: "https://jdelectricos.com.co/blog-materiales-electricos/" }],
});
</script>
