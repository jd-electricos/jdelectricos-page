<template>
  <div class="pt-16 pb-8 px-4">
    ...
    <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 pb-8">
      Noticias e Innovacion: Sector Eléctrico
    </h1>
...
// SEO
useHead({
  title: 'Noticias e Innovacion: Sector Eléctrico',
  meta: [
    {
      name: 'description',
      content: 'Noticias e Innovacion: Sector Eléctrico'
    },
    {
      name: 'keywords',
      content:
        'Noticias e Innovacion, Sector Eléctrico, Jd Electricos, sector electrico, noticias, innovacion'
    },
  ...
  link: [{ rel: 'canonical', href: 'https://jdelectricos.com.co/noticias' }]
})
</script>